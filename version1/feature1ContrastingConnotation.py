...
def writeFile(folder, file_name,type):
...
def main():
	...
	sarcastic = pwd + "/sarcastic_with_past_PP"
	writeFile(sarcastic, "feature1CCoutput.csv",1)
	writeFile(normal, "feature1CCoutput.csv",0)
