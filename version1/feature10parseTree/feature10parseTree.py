...
#pbgla: in this algorithm we detect the presence of sarcasm by checking the occurence of certain parse trees in the sentence
# check is sarcastic
...
def main():
    ...
    csvfile = open("feature10parseTree.csv","a")
